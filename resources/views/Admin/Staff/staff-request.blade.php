...
@section('content')
    <main>
        <div class="container">
            ...
            @endif
            <p class="mt-5 fw-bold fs-3">Data Pengajuan Verifikasi Tenaga Kesehatan</p>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="row">Bukti Tenaga Kesehatan</th>
                                <th scope="row">Institutsi Asal </th>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $user->user_evidence) }}"
                                            alt="Bukti Tenaga Kesehatan" style="max-width: 200px;">
                                    </td>
                                    <td>
                                        @foreach ($user->institution as $institution)
